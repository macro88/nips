## Event Kind 31989 — Handler recommendation

### Overview

Event Kind **31989** defines **handler recommendation** in Nostr.

- **Specification**: [NIP-89](https://github.com/nostr-protocol/nips/blob/master/89.md)
...
|---|---|---|---|---|---|---|
|*To be documented*|*TBD*|*TBD*|*TBD*|*TBD*|[NIP-89](https://github.com/nostr-protocol/nips/blob/master/89.md)|*TBD*|
