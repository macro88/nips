## Event Kind 1337 — Code Snippet

### Overview

Event Kind **1337** defines **code snippet** in Nostr.

- **Specification**: [NIP-C0](https://github.com/nostr-protocol/nips/blob/master/C0.md)
...
|---|---|---|---|---|---|---|
|*To be documented*|*TBD*|*TBD*|*TBD*|*TBD*|[NIP-C0](https://github.com/nostr-protocol/nips/blob/master/C0.md)|*TBD*|
