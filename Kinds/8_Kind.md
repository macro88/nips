## Event Kind 8 — Badge Award

### Overview

Event Kind **8** defines **badge award** in Nostr.

- **Specification**: [NIP-58](https://github.com/nostr-protocol/nips/blob/master/58.md)
...
|---|---|---|---|---|---|---|
|*To be documented*|*TBD*|*TBD*|*TBD*|*TBD*|[NIP-58](https://github.com/nostr-protocol/nips/blob/master/58.md)|*TBD*|
