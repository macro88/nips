...
Event Kind **13** defines **seal** in Nostr.

- **Specification**: [NIP-59](https://github.com/nostr-protocol/nips/blob/master/59.md)
...
|---|---|---|---|---|---|---|
|*To be documented*|*TBD*|*TBD*|*TBD*|*TBD*|[NIP-59](https://github.com/nostr-protocol/nips/blob/master/59.md)|*TBD*|
