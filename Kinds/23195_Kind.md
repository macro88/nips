## Event Kind 23195 — Wallet Response

### Overview

Event Kind **23195** defines **wallet response** in Nostr.
...
|---|---|---|---|---|---|---|
|*To be documented*|*TBD*|*TBD*|*TBD*|*TBD*|[NIP-47](https://github.com/nostr-protocol/nips/blob/master/47.md)|*TBD*|
