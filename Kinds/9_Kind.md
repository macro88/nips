## Event Kind 9 — Chat Message

### Overview

Event Kind **9** defines **chat message** in Nostr.

- **Specification**: [NIP-C7](https://github.com/nostr-protocol/nips/blob/master/C7.md)
...
|---|---|---|---|---|---|---|
|*To be documented*|*TBD*|*TBD*|*TBD*|*TBD*|[NIP-C7](https://github.com/nostr-protocol/nips/blob/master/C7.md)|*TBD*|
