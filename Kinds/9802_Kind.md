...
Event Kind **9802** defines **highlights** in Nostr.

- **Specification**: [NIP-84](https://github.com/nostr-protocol/nips/blob/master/84.md)
...
|---|---|---|---|---|---|---|
|*To be documented*|*TBD*|*TBD*|*TBD*|*TBD*|[NIP-84](https://github.com/nostr-protocol/nips/blob/master/84.md)|*TBD*|
