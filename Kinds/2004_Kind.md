## Event Kind 2004 — Torrent Comment

### Overview

Event Kind **2004** defines **torrent comment** in Nostr.

- **Specification**: [NIP-35](https://github.com/nostr-protocol/nips/blob/master/35.md)
...
|---|---|---|---|---|---|---|
|*To be documented*|*TBD*|*TBD*|*TBD*|*TBD*|[NIP-35](https://github.com/nostr-protocol/nips/blob/master/35.md)|*TBD*|
