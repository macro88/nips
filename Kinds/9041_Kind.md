## Event Kind 9041 — Zap Goal

### Overview

Event Kind **9041** defines **zap goal** in Nostr.

- **Specification**: [NIP-75](https://github.com/nostr-protocol/nips/blob/master/75.md)
...
|---|---|---|---|---|---|---|
|*To be documented*|*TBD*|*TBD*|*TBD*|*TBD*|[NIP-75](https://github.com/nostr-protocol/nips/blob/master/75.md)|*TBD*|
