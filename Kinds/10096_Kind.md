## Event Kind 10096 — File storage server list

### Overview

Event Kind **10096** defines **file storage server list** in Nostr.

- **Specification**: [NIP-96](https://github.com/nostr-protocol/nips/blob/master/96.md)
...
|---|---|---|---|---|---|---|
|*To be documented*|*TBD*|*TBD*|*TBD*|*TBD*|[NIP-96](https://github.com/nostr-protocol/nips/blob/master/96.md)|*TBD*|
