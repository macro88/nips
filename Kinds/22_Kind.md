## Event Kind 22 — Short-form Portrait Video Event

### Overview

Event Kind **22** defines **short-form portrait video event** in Nostr.

- **Specification**: [NIP-71](https://github.com/nostr-protocol/nips/blob/master/71.md)
...
|---|---|---|---|---|---|---|
|*To be documented*|*TBD*|*TBD*|*TBD*|*TBD*|[NIP-71](https://github.com/nostr-protocol/nips/blob/master/71.md)|*TBD*|
