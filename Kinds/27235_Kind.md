...
Event Kind **27235** defines **http auth** in Nostr.

- **Specification**: [NIP-98](https://github.com/nostr-protocol/nips/blob/master/98.md)
...
|---|---|---|---|---|---|---|
|*To be documented*|*TBD*|*TBD*|*TBD*|*TBD*|[NIP-98](https://github.com/nostr-protocol/nips/blob/master/98.md)|*TBD*|
