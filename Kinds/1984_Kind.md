## Event Kind 1984 — Reporting

### Overview

Event Kind **1984** defines **reporting** in Nostr.

- **Specification**: [NIP-56](https://github.com/nostr-protocol/nips/blob/master/56.md)
...
|---|---|---|---|---|---|---|
|*To be documented*|*TBD*|*TBD*|*TBD*|*TBD*|[NIP-56](https://github.com/nostr-protocol/nips/blob/master/56.md)|*TBD*|
