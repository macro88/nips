## Event Kind 38383 — Peer-to-peer Order events

### Overview

Event Kind **38383** defines **peer-to-peer order events** in Nostr.

- **Specification**: [NIP-69](https://github.com/nostr-protocol/nips/blob/master/69.md)
...
|---|---|---|---|---|---|---|
|*To be documented*|*TBD*|*TBD*|*TBD*|*TBD*|[NIP-69](https://github.com/nostr-protocol/nips/blob/master/69.md)|*TBD*|
