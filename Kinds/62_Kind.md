## Event Kind 62 — Request to Vanish

### Overview

Event Kind **62** defines **request to vanish** in Nostr.

- **Specification**: [NIP-62](https://github.com/nostr-protocol/nips/blob/master/62.md)
...
|---|---|---|---|---|---|---|
|*To be documented*|*TBD*|*TBD*|*TBD*|*TBD*|[NIP-62](https://github.com/nostr-protocol/nips/blob/master/62.md)|*TBD*|
