## Event Kind 20 — Picture

### Overview

Event Kind **20** defines **picture** in Nostr.

- **Specification**: [NIP-68](https://github.com/nostr-protocol/nips/blob/master/68.md)
...
|---|---|---|---|---|---|---|
|*To be documented*|*TBD*|*TBD*|*TBD*|*TBD*|[NIP-68](https://github.com/nostr-protocol/nips/blob/master/68.md)|*TBD*|
