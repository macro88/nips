...
Event Kind **30078** defines **application-specific data** in Nostr.

- **Specification**: [NIP-78](https://github.com/nostr-protocol/nips/blob/master/78.md)
...
|---|---|---|---|---|---|---|
|*To be documented*|*TBD*|*TBD*|*TBD*|*TBD*|[NIP-78](https://github.com/nostr-protocol/nips/blob/master/78.md)|*TBD*|
