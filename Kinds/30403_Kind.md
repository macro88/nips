## Event Kind 30403 — Draft Classified Listing

### Overview

Event Kind **30403** defines **draft classified listing** in Nostr.

- **Specification**: [NIP-99](https://github.com/nostr-protocol/nips/blob/master/99.md)
...
|---|---|---|---|---|---|---|
|*To be documented*|*TBD*|*TBD*|*TBD*|*TBD*|[NIP-99](https://github.com/nostr-protocol/nips/blob/master/99.md)|*TBD*|
