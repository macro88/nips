## Event Kind 1244 — Voice Message Comment

### Overview

Event Kind **1244** defines **voice message comment** in Nostr.

- **Specification**: [NIP-A0](https://github.com/nostr-protocol/nips/blob/master/A0.md)
...
|---|---|---|---|---|---|---|
|*To be documented*|*TBD*|*TBD*|*TBD*|*TBD*|[NIP-A0](https://github.com/nostr-protocol/nips/blob/master/A0.md)|*TBD*|
