## Event Kind 30315 — User Statuses

### Overview

Event Kind **30315** defines **user statuses** in Nostr.

- **Specification**: [NIP-38](https://github.com/nostr-protocol/nips/blob/master/38.md)
...
|---|---|---|---|---|---|---|
|*To be documented*|*TBD*|*TBD*|*TBD*|*TBD*|[NIP-38](https://github.com/nostr-protocol/nips/blob/master/38.md)|*TBD*|
