## Event Kind 2 — Recommend Relay

### Overview

Event Kind **2** defines **recommend relay** in Nostr.
...
|---|---|---|---|---|---|---|
|*To be documented*|*TBD*|*TBD*|*TBD*|*TBD*|[NIP-01](https://github.com/nostr-protocol/nips/blob/master/01.md)|*TBD*|
