## Event Kind 38172 — Cashu Mint Announcement

### Overview

Event Kind **38172** defines **cashu mint announcement** in Nostr.

- **Specification**: [NIP-87](https://github.com/nostr-protocol/nips/blob/master/87.md)
...
|---|---|---|---|---|---|---|
|*To be documented*|*TBD*|*TBD*|*TBD*|*TBD*|[NIP-87](https://github.com/nostr-protocol/nips/blob/master/87.md)|*TBD*|
