## Event Kind 10 — Group Chat Threaded Reply

### Overview

Event Kind **10** defines **group chat threaded reply** in Nostr.

- **Specification**: [NIP-29](https://github.com/nostr-protocol/nips/blob/master/29.md)
...
|---|---|---|---|---|---|---|
|*To be documented*|*TBD*|*TBD*|*TBD*|*TBD*|[NIP-29](https://github.com/nostr-protocol/nips/blob/master/29.md)|*TBD*|
