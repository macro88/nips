## Event Kind 10019 — Nutzap Mint Recommendation

### Overview

Event Kind **10019** defines **nutzap mint recommendation** in Nostr.

- **Specification**: [NIP-61](https://github.com/nostr-protocol/nips/blob/master/61.md)
...
|---|---|---|---|---|---|---|
|*To be documented*|*TBD*|*TBD*|*TBD*|*TBD*|[NIP-61](https://github.com/nostr-protocol/nips/blob/master/61.md)|*TBD*|
