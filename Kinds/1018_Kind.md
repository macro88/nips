## Event Kind 1018 — Poll Response

### Overview

Event Kind **1018** defines **poll response** in Nostr.

- **Specification**: [NIP-88](https://github.com/nostr-protocol/nips/blob/master/88.md)
...
|---|---|---|---|---|---|---|
|*To be documented*|*TBD*|*TBD*|*TBD*|*TBD*|[NIP-88](https://github.com/nostr-protocol/nips/blob/master/88.md)|*TBD*|
