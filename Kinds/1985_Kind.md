## Event Kind 1985 — Label

### Overview

Event Kind **1985** defines **label** in Nostr.

- **Specification**: [NIP-32](https://github.com/nostr-protocol/nips/blob/master/32.md)
...
|---|---|---|---|---|---|---|
|*To be documented*|*TBD*|*TBD*|*TBD*|*TBD*|[NIP-32](https://github.com/nostr-protocol/nips/blob/master/32.md)|*TBD*|
