## Event Kind 14 — Direct Message

### Overview

Event Kind **14** defines **direct message** in Nostr.

- **Specification**: [NIP-17](https://github.com/nostr-protocol/nips/blob/master/17.md)
...
|---|---|---|---|---|---|---|
|*To be documented*|*TBD*|*TBD*|*TBD*|*TBD*|[NIP-17](https://github.com/nostr-protocol/nips/blob/master/17.md)|*TBD*|
